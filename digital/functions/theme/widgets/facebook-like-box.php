...
<?php
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' => 'Like us on Facebook', 'pageurl' => 'http://www.facebook.com/wpzoom', 'width' => 200, 'bordercolor' => 'e6e2dc', 'show_faces' => 'on', 'show_stream' => 'off', 'show_header' => 'off' );
			...
			<p>
				...
				<small>* Default: <strong>200</strong> </small>
			</p>
			<p>
